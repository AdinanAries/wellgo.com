    ...
    return (
        <div id="selected_ticket_main_details_pane">
                ...
                <div className="selected_ticket_book_btn_container">
                    <div onClick={()=>{props.begin_checkout(data);
                        setTimeout(()=>global.__unselectFlightOffer(),300)}/*()=>global.show_start_checkout_page(`${global.stringify_obj_for_template_strings(global.checkout_obj)}`)*/} className="selected_ticket_book_btn">
