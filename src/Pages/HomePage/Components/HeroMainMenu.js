        ...
        <div style={{position: "relative", border: "1px solid rgba(255,255,255,0.07)", borderRadius: 10, marginBottom: 40}}>
            <div style={{display: "flex", justifyContent: "center"}}>
                ...
                <div className="agent_hero_menu_item main" id="landing_page_hero_manu_bar_bot_item" style={{cursor: "pointer", textAlign: "center", color: "rgba(169, 221, 255, 0.8)", marginLeft: 20, fontSize: 14, padding: "20px 10px", fontFamily: "'Prompt', Sans-serif"}}>
                    ...
                    Agent</div>
                <div className="currency_hero_menu_item main" style={{cursor: "not-allowed", textAlign: "center", color: "rgba(255,255,255,0.4)", marginLeft: 20, fontSize: 14, padding: "20px 10px", fontFamily: "'Prompt', Sans-serif"}}>
                    <i style={{marginRight: 10}} className="fa-solid fa-globe"></i>
                    USD</div>
                <div className="language_hero_menu_item main" style={{cursor: "not-allowed", textAlign: "center", color: "rgba(255,255,255,0.4)", marginLeft: 20, fontSize: 14, padding: "20px 10px", fontFamily: "'Prompt', Sans-serif"}}>
                ...
                <div className="more_hero_menu_item main" style={{position: "relative"}}>
                    ...
                    <div style={{display: showDropDown ? "block" : "none", position: "absolute", zIndex: 10, width: 150, padding: 10, top: "80%", boxShadow: "1px 2px 3px rgba(0,0,0,0.4)", right: 0, backgroundColor: "rgb(43, 52, 61)", border: "1px solid rgba(255,255,255,0.07)", borderRadius: 10}}>
                        <div className="cars_hero_menu_item dropdown" style={{cursor: "not-allowed", textAlign: "initial", color: "rgba(255,255,255,0.4)", fontSize: 14, padding: "10px", fontFamily: "'Prompt', Sans-serif"}}>
                            <i style={{marginRight: 10}} className="fa-solid fa-car"></i>
                            Cars</div>
                        <div className="packages_hero_menu_item dropdown" style={{cursor: "not-allowed", textAlign: "initial", color: "rgba(255,255,255,0.4)", fontSize: 14, padding: "10px", fontFamily: "'Prompt', Sans-serif"}}>
                            <i style={{marginRight: 10}} className="fa-solid fa-box-open"></i>
                            Packages</div>
                        <div className="agent_hero_menu_item dropdown" id="landing_page_hero_manu_bar_bot_item" style={{cursor: "pointer", textAlign: "initial", color: "rgba(169, 221, 255, 0.8)", fontSize: 14, padding: "10px", fontFamily: "'Prompt', Sans-serif"}}>
                            <i style={{marginRight: 10}} className="fa-solid fa-robot"></i>
                            Agent</div>
                        <div className="currency_hero_menu_item dropdown" style={{cursor: "not-allowed", textAlign: "initial", color: "rgba(255,255,255,0.4)", fontSize: 14, padding: "10px", fontFamily: "'Prompt', Sans-serif"}}>
                            <i style={{marginRight: 10}} className="fa-solid fa-globe"></i>
                            USD</div>
                        <div className="language_hero_menu_item dropdown" style={{cursor: "not-allowed", textAlign: "initial", color: "rgba(255,255,255,0.4)", fontSize: 14, padding: "10px", fontFamily: "'Prompt', Sans-serif"}}>
                            <i style={{marginRight: 10}} className="fa-solid fa-language"></i>
                            English</div>
                        <div className="feedback_hero_menu_item dropdown" style={{cursor: "not-allowed", textAlign: "initial", color: "rgba(255,255,255,0.4)", fontSize: 14, padding: "10px", fontFamily: "'Prompt', Sans-serif"}}>
