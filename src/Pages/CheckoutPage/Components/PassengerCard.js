...
const PassengerCard = (props) => {
    ...
    return (
        <div onClick={()=>props.selectPassengerCard(props.index)} style={{position: "relative", border: "1px dashed rgba(0,0,0,0.2)", cursor: "pointer", minHeight: 60, width: "calc(50% - 5px)", padding: 10, borderRadius: 8}}>
