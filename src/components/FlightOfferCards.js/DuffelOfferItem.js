const DuffelOfferItem = (props) => {
    console.log(props);
    const { total_amount } = props.flight;
    return (
        <div onClick={global.show_selected_ticket_details_pane} style={{cursor: "pointer", backgroundColor: "rgba(255,255,255,0.7)", borderRadius: 9, marginBottom: 10, padding: "15px 10px"}}>
