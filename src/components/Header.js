            ...
            <div className="wrapper">
                <div className="header_content_container" style={{display: "flex", justifyContent: "space-between"}}>
                    ...
                    <div className="header-menu-items">
                        ...
                        <div id="desktop_search_menu_item" onClick={()=>{show_home_page(false);props.show_home_page();}} className="each-header-menu-item active">
                    ...
                    <div className="header_humburger_menu">
                        <div className="header_mobile_menus" style={{display: "flex", flexDirection: "row"}}>
                            ...
                            <div id="mobile_search_menu_item" style={{marginRight: 18}} className="header_mobile_menus_item active" onClick={()=>{show_home_page(false);props.show_home_page();}}>
