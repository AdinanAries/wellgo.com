        ...
        <div className="support_chat_sub_container" id="support_chat_start_page_container" style={{display: "none"}}>
            <div style={{padding: "10px", position: "relative"}}>
                ...
                <div style={{position: "relative"}}>
                    {
                        (CONSTANTS.disabled_features.bot_aide.history_page) && <div style={{backgroundColor: "rgba(255,255,255,0.8)", display: "flex", justifyContent: "center", alignItems: "center", zIndex: 1, position: "absolute", padding: 10, width: "calc(100% - 20px)", height: "calc(100%)"}}>
