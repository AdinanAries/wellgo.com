...
const FullPageGallery = (props) => {
    ...
    return (
        <div style={{display: "flex", justifyContent: "center", alignItems: "center", backgroundColor: "rgb(43, 52, 61)", position: "fixed", left: 0, top: 0, width: "100vw", height: "100vh", zIndex: 10001}}>
            <p onClick={toggleShowGallery} style={{width: 33, height: 33, display: "flex", justifyContent: "center", alignItems: "center", borderRadius: "100%", background: "crimson", color: "white", position: "absolute", top: 10, right: 20, cursor: "pointer"}}>
